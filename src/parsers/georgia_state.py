...
class GeorgiaStateParser(BasePlacementParser):
    university_slug = "georgia_state"
    ...
    def parse(self, html: str, page_url: str) -> list[PlacementRow]:
        ...
        if rows:
            log.info("Parsed %d placement rows from Georgia State", len(rows))
            return rows
